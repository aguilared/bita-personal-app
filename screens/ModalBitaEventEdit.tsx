...
export default function ModalBitaEventEdit(Routes: Props) {
  ...
  console.log("BitaEventID", bitaEvents);
  ...
  const [isImage, setIsImage] = useState(bitaEvents.image);
    ...
    try {
      ...
      setTimeout(() => {
        navigation.navigate("ModalBitacoraId", {
          id: bitaEvents.bitacora_id,
          author_id: bitaEvents.author_id,
          bitacora_date: bitaEvents.bitacora_date,
          eventos: bitaEvents.eventos,
        });
      }, 600);
    } catch (error) {
      console.log(error);
        ...
        <Portal>
          ...
          >
            <Dialog.Title style={styles.title}>
              Edit Actividad: {bitaEvents.bitacora_id}
            </Dialog.Title>
